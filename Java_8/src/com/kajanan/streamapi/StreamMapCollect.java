...
public class StreamMapCollect {
	...
	public static void main(String[] args) {
		...
		users.add(new User(1, "Kajanan", "Kajanan19", "kajanan@gmail.com"));
		users.add(new User(2, "Sarujan", "Sarujan10", "sarujan@gmail.com"));
		users.add(new User(3, "Saravanan", "Saravanan31", "saravanan@gmail.com"));
		...
		List<UserDTO> userDTOListAfterMap = users.stream()
				.map((User user) -> new UserDTO(user.getId(), user.getUserName(), user.getEmail()))
				.collect(Collectors.toList());

		userDTOListAfterMap.forEach((userdto) -> System.out.println(userdto));
	}
